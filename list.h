...
void deleteItem(struct Performance * performance, sturct Node ** list_ptr, unsigned int index);
int findItem(struct Performance * performance, struct Node ** list_ptr, int (*compar)(cont void *, const void *), void * target, unsigned int width);
